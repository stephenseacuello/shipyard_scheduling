...
DRY_DOCKS: Dict[str, GeoFacility] = {
    "dock_1": GeoFacility(
        ...
        label="Dock 1 (490m - VLCC/LNG)",
        color="#e74c3c",
        production_stage="ERECTION",
    ),
    "dock_2": GeoFacility(
        center=(35.5055, 129.4230),
        polygon=[
            (35.5065, 129.4215),
            (35.5065, 129.4245),
            (35.5045, 129.4245),
    ...
    "dock_4": GeoFacility(
        ...
        label="Dock 4 (390m - LNG)",
        color="#e74c3c",
        production_stage="ERECTION",
    ),
    "dock_5": GeoFacility(
        center=(35.4995, 129.4228),
        polygon=[
            (35.5005, 129.4215),
            (35.5005, 129.4241),
            (35.4985, 129.4241),
...
GOLIATH_CRANES: Dict[str, Tuple[float, float]] = {
    ...
    "GC04": (35.5035, 129.4220),  # Dock 3
    "GC05": (35.5018, 129.4220),  # Dock 4
    "GC06": (35.5008, 129.4220),  # Dock 4
    "GC07": (35.4995, 129.4218),  # Dock 5
    "GC08": (35.4942, 129.4215),  # Dock 8
    "GC09": (35.4908, 129.4210),  # Dock 10
}
...
CRANE_RAILS: Dict[str, Dict[str, Tuple[float, float]]] = {
    ...
    "dock_3": {"start": (35.5045, 129.4215), "end": (35.5025, 129.4215)},
    "dock_4": {"start": (35.5025, 129.4215), "end": (35.5005, 129.4215)},
    "dock_5": {"start": (35.5005, 129.4215), "end": (35.4985, 129.4215)},
    "dock_8": {"start": (35.4952, 129.4210), "end": (35.4932, 129.4210)},
    "dock_10": {"start": (35.4918, 129.4208), "end": (35.4898, 129.4208)},
}
